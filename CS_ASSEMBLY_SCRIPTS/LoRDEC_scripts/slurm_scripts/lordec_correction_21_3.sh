...
##########
#SBATCH --job-name=pac3
#SBATCH --workdir=./
######SBATCH --workdir=./
######SBATCH -o ./LoRDEC_out.txt 
######SBATCH -e ./LoRDEC_err.txt 
#######SBATCH -o ./deBruijn21_3_out.txt 
#######SBATCH -e ./deBruijn21_3_err.txt 
...
seq 1 6 | parallel lordec-correct -T 8 -S corrected_21_3_subreads{}_stats.txt -m 62000 -a 100000 -i $DATA_DIR/subreads{}.fastq.gz -2 $DBG_DIR/illumina_21_3 -k 21 -s 3 -o corrected_21_3_subreads{}.fasta >> log_subreads{}.log 2>> log_err_subreads{}.txt
