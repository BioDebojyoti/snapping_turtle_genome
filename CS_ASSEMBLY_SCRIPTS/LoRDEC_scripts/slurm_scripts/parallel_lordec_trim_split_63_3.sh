...
##########
#SBATCH --job-name=parallel_trim_split_63_3
#SBATCH --workdir=./
######SBATCH --workdir=./
#SBATCH -o ./parallel_trim_split_63_3_out.txt 
#SBATCH -e ./parallel_trim_split_63_3_err.txt 
...
seq 1 6 | parallel lordec-trim-split -i $DATA_DIR/iterated_corrected_63_3_subreads{}.fasta -o iterated_corrected_trim_split_63_3_subreads{}.fasta 
