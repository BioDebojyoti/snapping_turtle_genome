...
##########
#SBATCH --job-name=63_3_parallel_two_step_iterated_correction
#SBATCH --workdir=./
######SBATCH --workdir=./
#SBATCH -o ./parallel_lordec_two_step_iterated_correction_63_3_out.txt 
#SBATCH -e ./parallel_lordec_two_step_iterated_correction_63_3_err.txt 
...
seq 1 6 | parallel lordec-correct -T 8 -m 62000 -a 100000 -i $DATA_DIR/two_step_corrected_41_3_subreads{}.fasta -2 $DBG_DIR/illumina_63_3 -k 63 -s 3 -o two_step_corrected_63_3_subreads{}.fasta 
