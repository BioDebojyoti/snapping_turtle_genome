...
##########
#SBATCH --job-name=21_3_parallel_two_step_iterated_correction
#SBATCH --workdir=./
######SBATCH --workdir=./
#SBATCH -o ./parallel_lordec_two_step_iterated_correction_21_3_out.txt 
#SBATCH -e ./parallel_lordec_two_step_iterated_correction_21_3_err.txt 
...
seq 1 6 | parallel lordec-correct -T 8 -m 62000 -a 100000 -i $DATA_DIR/corrected_19_3_subreads{}.fasta -2 $DBG_DIR/illumina_21_3 -k 21 -s 3 -o two_step_corrected_21_3_subreads{}.fasta 
