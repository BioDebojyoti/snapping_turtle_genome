...
##########
#SBATCH --job-name=DBG_63_3
#SBATCH --workdir=./
######SBATCH --workdir=./
#SBATCH -o ./deBruijn63_3_out.txt 
#SBATCH -e ./deBruijn63_3_err.txt 
