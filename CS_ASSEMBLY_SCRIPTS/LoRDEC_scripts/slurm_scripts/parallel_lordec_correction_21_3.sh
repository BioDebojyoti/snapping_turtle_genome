...
##########
#SBATCH --job-name=parallel_correction
#SBATCH --workdir=./
######SBATCH --workdir=./
#SBATCH -o ./parallel21_3_out.txt 
#SBATCH -e ./parallel21_3_err.txt 
...
seq 1 6 | parallel lordec-correct -T 8 -m 62000 -a 100000 -i $DATA_DIR/subreads{}.fastq.gz -2 $DBG_DIR/illumina_21_3 -k 21 -s 3 -o corrected_21_3_subreads{}.fasta >> log_21_3_subreads{}.log 2>> err_21_3_subreads{}.txt
