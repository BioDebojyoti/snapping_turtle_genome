...
##########
#SBATCH --job-name=iterated_correction_41_3
#SBATCH --workdir=./
######SBATCH --workdir=./
#SBATCH -o ./iterated_correction41_3_out.txt 
#SBATCH -e ./iterated_correction41_3_err.txt 
...
seq 1 6 | parallel lordec-correct -T 8 -m 62000 -a 100000 -i $DATA_DIR/iterated_corrected_trim_split_21_3_subreads{}.fasta -2 $DBG_DIR/illumina_41_3 -k 41 -s 3 -o iterated_corrected_41_3_subreads{}.fasta
